  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved incident as @incident" do
        ...
        post :create, {:incident => { "street" => "invalid value" }}, valid_session
        assigns(:incident).should be_a_new(Incident)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested incident" do
        ...
        Incident.any_instance.should_receive(:update_attributes).with({ "street" => "MyString" })
        put :update, {:id => incident.to_param, :incident => { "street" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the incident as @incident" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Incident.any_instance.stub(:save).and_return(false)
        put :update, {:id => incident.to_param, :incident => { "street" => "invalid value" }}, valid_session
        assigns(:incident).should eq(incident)
      end
